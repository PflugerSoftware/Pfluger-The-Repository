      ...
      >
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-4">
            ...
            <p className="text-sm text-accent font-medium tracking-wide uppercase">AI at Pfluger</p>
          </div>
          <h1 className="text-hero mb-4">Meet Ezra</h1>
        ...
        <div className="space-y-6 mb-16">
          <h2 className="text-h3">What Ezra Does</h2>
        ...
        {/* Capabilities Grid */}
        <div className="mb-16">
          <h2 className="text-h3 mb-8">Capabilities</h2>
            ...
            {CAPABILITIES.map((cap, i) => (
              ...
              >
                <div className="w-9 h-9 rounded-lg bg-accent/10 flex items-center justify-center mb-4">
                  <cap.icon className="w-4.5 h-4.5 text-accent" />
                </div>
                <h3 className="text-h4 mb-2">{cap.title}</h3>
                <p className="text-body-muted leading-relaxed">{cap.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        {/* How it works */}
        <div className="mb-16">
          <h2 className="text-h3 mb-6">How It Works</h2>
            ...
            {[
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-body-subtle">{item.detail}</p>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        {/* Our approach */}
        <div className="mb-16">
          <h2 className="text-h3 mb-6">Our Approach to AI</h2>
        ...
        <div className="p-6 bg-white/5 border border-white/10 rounded-xl">
          <div className="flex items-center gap-2 mb-3">
            <Bot className="w-4 h-4 text-foreground-subtle" />
            <p className="text-xs text-foreground-subtle uppercase tracking-wide">Technical Note</p>
          </div>
          <p className="text-body-muted leading-relaxed">
            Ezra is powered by Anthropic's Claude via Supabase Edge Functions. The web app
            uses the <code className="text-accent/70">claude</code> edge function, while the
            Revit add-in uses the <code className="text-accent/70">ezra-revit</code> edge
            function with additional Revit model context. Both query the
            same <code className="text-accent/70">project_blocks</code> table for RAG retrieval.
          </p>
        </div>
      </motion.div>
    </div>
