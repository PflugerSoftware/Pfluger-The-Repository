...
const SURVEY_SLUG = 'CentralTexasCollegeMasterPlanSurvey2026';

export default function CtcSurveyPage() {
  ...
  useEffect(() => {
    ...
    const m = new mapboxgl.Map({
      ...
      center: [survey.map_center_lng || -97.806215, survey.map_center_lat || 31.116726],
      zoom: survey.map_zoom || 15,
      pitch: 0,
      antialias: true,
    });
