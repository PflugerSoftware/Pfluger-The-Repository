...
const STATUS_CONFIG: Record<string, {
  ...
  draft: { label: 'Draft', color: 'text-muted-foreground', borderColor: 'border-border', icon: Edit3, borderStyle: 'border-dashed' },
  pending: { label: 'Submitted', color: 'text-warning', borderColor: 'border-warning/50', icon: Clock },
  revise: { label: 'Revise', color: 'text-info', borderColor: 'border-info/50', icon: Edit3 },
  greenlit: { label: 'Green Lit', color: 'text-success', borderColor: 'border-success/50', icon: Zap },
};
      ...
      <div className="flex-1 overflow-y-auto px-3 pb-4">
        {pitches.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-body-subtle">No pitches yet</p>
          </div>
        ) : (
