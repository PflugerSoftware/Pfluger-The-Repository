...
| Magnific GUI | AI image upscaling | $39/mo, $468/yr | apps@pflugerarchitects.com, email verify |
...
| Service | Purpose | Cost | Login |
|---------|---------|------|-------|
| CapCut Pro | Video editing | $20/mo, $240/yr | apps@pflugerarchitects.com, email verify |
...
| Bluehost | Hosts the websites | Existing | domain@pflugerarchitects.com, email verify |
...
| Mapbox API | Interactive maps | Free tier (50k loads/mo) | software@pflugerarchitects.com, kk(otS0>H-9r<kRHY|Cc |
| Census API | Demographics / district data | Free | software@pflugerarchitects.com |
